...
sed -e "s/{{ GIT_SHA }}/${git_sha}/g; s/{{ SLACK_CHANNELS }}/${SLACK_CHANNELS}/g; s/{{ JIRA_HOST }}/${JIRA_HOST}/g; s/{{ FREQUENCY_IN_MINUTES }}/${frequency}/g" ./kubernetes/templates/cronjob.tpl > ./kubernetes/manifests/2-cronjob.yaml
